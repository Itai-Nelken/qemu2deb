...
#functions
function intro() {
    echo "this script doesn't do anything and exists only for my testing."
    echo -e "
    #################################################
...
function install-depends() {
    echo "sudo apt install -y build-essential ninja-build libepoxy-dev libdrm-dev libgbm-dev libx11-dev libvirglrenderer-dev libpulse-dev libsdl2-dev git libglib2.0-dev libfdt-dev libpixman-1-dev zlib1g-dev libepoxy-dev libdrm-dev libgbm-dev libx11-dev libvirglrenderer-dev libpulse-dev libsdl2-dev"
}
...
function compile-qemu() {
    ...
    echo 'git clone https://git.qemu.org/git/qemu.git
    cd qemu
    git submodule init
